<x-guest-layout>
    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col text-center w-1/2 mx-auto justify-center items-center">
        ...
        <div class="mb-6 flex">
            ...
            <div>
                <input type="submit" class="bg-black mt-5 cursor-pointer hover:bg-[#2635da] px-7 py-3 text-2xl rounded text-white "
